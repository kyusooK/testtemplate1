    ...
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openOrderUpdate"
            >
                OrderUpdate
            </v-btn>
            <v-dialog v-model="orderUpdateDiagram" width="500">
                <OrderUpdateCommand
                    @closeDialog="closeOrderUpdate"
	...
	async created() {
        ...
        methods: {
            ...
            async orderUpdate(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['orderupdate'].href), params)
            ...
            openOrderUpdate() {
                this.orderUpdateDiagram = true;
            },
            closeOrderUpdate() {
                this.orderUpdateDiagram = false;
            },
        },
    }
</script>
